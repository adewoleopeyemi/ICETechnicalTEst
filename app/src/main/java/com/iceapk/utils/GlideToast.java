...
public class GlideToast {
    ...
    public static int LENGTHLONG = 1500;
    ...
    public static class makeToast {
        ...
        public makeToast(Activity activity, String message, int duration,String style,int gravity,int icon, int backgroundcolor, int textColor) {
            this.activity = activity;
            this.message = message;
            this.duration = duration;
            this.style = style;
